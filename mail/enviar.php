...
if(empty($_REQUEST['nombre']) || empty($_REQUEST['email']) || empty($_REQUEST['asunto']) || empty($_REQUEST['mensaje']))
{
	echo "<script> window.location ='contacto.html';</script>";
		...
		//CORREO DESTINO
		$cor="cabinaslossantillos08@gmail.com, kenth1977@gmail.com";
		...
		//Mail del sitio
		$de .="From: Cabinas Los Santillos<cabinaslossantillos08@gmail.com>\r\n";
		...
		$mensaje="
					...
					<hr>
					<a href='http://http://cabinaslossantillos.com' target='_blank'>http://cabinaslossantillos.com</a>
				";
